...
domain_setup() {
    ...
    sudo apt purge -y libpam-krb5 --autoremove
    sudo apt install -y astra-ad-sssd-client fly-admin-ad-sssd-client 
...
install_programs() {
    ...
    sudo apt install -y seahorse yandex-browser-stable cifs-utils htop glmark2 \
        ...
        libmspack0 cabextract zenity playonlinux
...
EOF
    ...
    add_mount_point "base" "//law/base" "cifs domain=adm.local,username=$profil_user,password=$paroll_user,vers=1.0,iocharset=utf8,file_mode=0777,dir_mode=0777,rw 0 0"

    add_mount_point "mail" "//fsrv/mail" "cifs domain=adm.local,username=$profil_user,password=$paroll_user,vers=1.0,iocharset=utf8,file_mode=0777,dir_mode=0777,rw 0 0"

    add_mount_point "consplus" "//cons/consplus" "cifs domain=adm.local,username=$profil_user,password=$paroll_user,vers=1.0,iocharset=utf8,file_mode=0777,dir_mode=0777,rw 0 0"

    add_mount_point "consplusregion" "//cons/consplusregion" "cifs domain=adm.local,username=$profil_user,password=$paroll_user,vers=1.0,iocharset=utf8,file_mode=0777,dir_mode=0777,rw 0 0"

    add_mount_point "kodeks_client" "//cons/kodeks_client" "cifs vers=2.0,domain=adm.local,username=$profil_user,password=$paroll_user,vers=1.0,iocharset=utf8,file_mode=0777,dir_mode=0777,rw 0 0"
